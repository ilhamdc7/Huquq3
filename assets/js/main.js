(function($) {
    ...
    setTimeout(() => {
        ...
        var progress2 = 0.1
        var progress = 0.1
        $('#progress').find('#blue').animate({
            'stroke-dashoffset': 198 * progress
        }, 2000)
        $('#progress1').find('#blue1').animate({
            'stroke-dashoffset': 198 * progress
        }, 2000)
        $('#progress2').find('#blue2').animate({
            'stroke-dashoffset': 198 * progress2
        }, 2000)
        $('#progress3').find('#blue3').animate({
            'stroke-dashoffset': 198 * progress3
        }, 2000)
        $('#progress4').find('#blue4').animate({
            'stroke-dashoffset': 198 * progress4
        }, 2000)
    }, 1600)
}(jQuery));